       ...
       <div className="container">
         <div className="row">
           <div className="col-md-4">
             <div className="logo">
               <h6 className="text-white">Mashable Clone</h6>
             </div>
             <div className="contact-details">
               <p>Safari Code Camp</p>
               <p>Phone: (020) 123 456 789</p>
               <p>Email: <a href="mailto:festus.yeboah@hotmail.com">Safari Code Camp</a></p>
           ...
           <div className="col-md-4">
             <div className="latest-posts"><a href="#">
                 <div className="post d-flex align-items-center">
                   <div className="image"><img src="assets/img/small-thumbnail-1.jpg" alt="..." className="img-fluid"/></div>
                   <div className="title"><strong>Hotels for all budgets</strong><span className="date last-meta">October 26, 2016</span></div>
                 </div></a><a href="#">
                 <div className="post d-flex align-items-center">
                   <div className="image"><img src="assets/img/small-thumbnail-2.jpg" alt="..." className="img-fluid"/></div>
                   <div className="title"><strong>Great street atrs in London</strong><span className="date last-meta">October 26, 2016</span></div>
                 </div></a><a href="#">
                 <div className="post d-flex align-items-center">
                   <div className="image"><img src="assets/img/small-thumbnail-3.jpg" alt="..." className="img-fluid"/></div>
         ...
         <div className="container">
           <div className="row">
             ...
             <div className="col-md-6 text-right">
               <p>Template By <a href="https://bootstraptemple.com" className="text-white">Bootstrap Temple</a> </p>
                 <p>Powered by  <a href="https://newsapi.org/" className="text-white" >News API </a>
               </p>
             </div>
           </div>
         </div>
